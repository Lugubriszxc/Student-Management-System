            ...
            try
            {
                if (choice == 1) //checkbox2 // Add new subject
                {
                    for (int i = 0; i < dataGridView1.Rows.Count - 1; i++)
                    {
                        try
                        {
                                SqlCommand cmd4 = new SqlCommand("INSERT INTO Grades (Subject, TotalUnit, GWA, Remarks, StudentID) VALUES (@Subject, '" + textTotalUnit.Text + "', '" + textGWA.Text + "', '" + textAssessment1.Text + "', '" + StudentID + "')", con);
                                cmd4.Parameters.AddWithValue("@Subject", Convert.ToString(dataGridView1.Rows[i].Cells[1].Value));
                        ...
                        {
                                SqlCommand cmd4 = new SqlCommand("INSERT INTO Grades (Subject, TotalUnit, GWA, Remarks, StudentID) VALUES (@Subject, '" + textTotalUnit.Text + "', '" + textGWA.Text + "', '" + textAssessment1.Text + "', '" + StudentID + "')", con);
                                cmd4.Parameters.AddWithValue("@Subject", "");
                                cmd4.ExecuteNonQuery();
                        ...
                        try
                        {
                            SqlCommand cmd6 = new SqlCommand("UPDATE Grades SET Unit = @Unit WHERE SubjectID = '" + SubjectID + "'", con);
                        ...
                        {
                            SqlCommand cmd6 = new SqlCommand("UPDATE Grades SET Unit = @Unit WHERE SubjectID = '" + SubjectID + "'", con);
                            cmd6.Parameters.AddWithValue("@Unit", "");
                            cmd6.ExecuteNonQuery();
                        }

                        try
                        {
                            SqlCommand cmd7 = new SqlCommand("UPDATE Grades SET Instructor = @Instructor WHERE SubjectID = '" + SubjectID + "'", con);
                            cmd7.Parameters.AddWithValue("@Instructor", Convert.ToString(dataGridView1.Rows[i].Cells[3].Value));
                            cmd7.ExecuteNonQuery();
                        }
                        catch
                        {
                            SqlCommand cmd7 = new SqlCommand("UPDATE Grades SET Instructor = @Instructor WHERE SubjectID = '" + SubjectID + "'", con);
                            cmd7.Parameters.AddWithValue("@Instructor", "");
                            cmd7.ExecuteNonQuery();
                        }

                        try
                        {
                            SqlCommand cmd8 = new SqlCommand("UPDATE Grades SET Grade = @Grade WHERE SubjectID = '" + SubjectID + "'", con);
                            cmd8.Parameters.AddWithValue("@Grade", Convert.ToString(dataGridView1.Rows[i].Cells[4].Value));
                            cmd8.ExecuteNonQuery();
                        }
                        catch
                        {
                            SqlCommand cmd8 = new SqlCommand("UPDATE Grades SET Grade = @Grade WHERE SubjectID = '" + SubjectID + "'", con);
                            cmd8.Parameters.AddWithValue("@Grade", "");
                            cmd8.ExecuteNonQuery();
                        }
                    }
